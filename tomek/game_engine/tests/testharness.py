...
class TomekTestSuite(unittest.TestCase):
    ...
    def test_correctness_of_verify_game_state_consistency_5(self):
        ...
        # State our expectation about the result of the transformation
        with self.assertRaises(GameStateIsNotAHashError):
            verify_game_state_consistency(game_state, who_moves_next)

    def test_correctness_of_verify_game_state_consistency_6(self):
        ...
        # State our expectation about the result of the transformation
        with self.assertRaises(GameStateLengthError):
            verify_game_state_consistency(game_state, who_moves_next)
